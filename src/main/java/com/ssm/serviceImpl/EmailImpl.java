...
/*
    ...
    public String send(Map<String, String> param, HttpServletRequest request) throws ToolsException {
...
//        String myEmailPassword=email.getEmailPassword();
        String smtpPort = "587";//端口号
        String encryption = "ssl";//加密类型
        String myEmailSMTPHost="smtp.qq.com";
        String myEmailAccount="865202106@qq.com";
        String myEmailPassword="sunshine,1996911";
        //得到对应需发送的模板
//       Theme theme=themeDao.findByCode(code);
//        String themeTitle=theme.getTitle();
//        String content=theme.getThemeTemplate();
        String themeTitle="验证码";
        String content="您的验证码为:"+code+",有效期为15分钟";
...
//        final String smtpPort = "25";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String themeName,String content) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "prdear", "UTF-8"));
