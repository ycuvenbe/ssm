...
package com.ssm.utiltools.basic;
...
//            return jsonStr;
    ...
    public static void verify(Object param) throws ToolsException {
        if (isEmpity(param)) {
            throw new ToolsException("500","缺少必填参数");
        }
    }


    public static void verify(Object param, String errorCode) throws ToolsException {
        if (isEmpity(param)) {
            throw new ToolsException("500",errorCode+"为空");
        }
    }

    public static void verify(Object param, String errorCode, String errorMsg) throws ToolsException {
        if (isEmpity(param)) {
            throw new ToolsException(errorCode, errorMsg);
        }
    }

    public static void verify(Map<String, String> param, String[] keys) throws ToolsException {
    ...
    *@Params
    */
    public static void verifyNotExist(Object object,String msg)throws ToolsException {
        if(null == object){
            isError(msg);
        }
    }
    ...
    *@Params
    */
    public static void verifyExist(Object object,String msg)throws ToolsException {
        if(null!=object){
            isError(msg);;
        }
    }
    ...
    *@Params
    */
    public static Boolean verifyIsTrue(String origin,String now)throws ToolsException {
    ...
    public static void isError(String message)throws ToolsException {
            throw new ToolsException("500",message);
    }
}
